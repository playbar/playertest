 ...
 */
public class OrderModule extends BasicModule {
	 ...
	 */
	public String createOrder(String payerId, String thirdId, String receiverId, String goodId, int goodCnt, Constant.payChannel channel, String orderChannel, String appchannel) {
		...
		newOrder.setOrderChannel(orderChannel);
		newOrder.setChannel(appchannel);
	...
	public ArrayList<AD> getADList(String status) {
		return this.getOrderDao().getADList(status);
	}

	public ArrayList<Server> getServers() {
		return this.getOrderDao().getServers();
	 ...
	 * @return
	 * @author ZuKang.Song
	 * @since 2016年6月8日下午12:10:45
	 */
	public String addServerInfo(String ip, String port, String description) {
		return this.getOrderDao().addServerInfo(ip, port, description);
	}
	 ...
	 * @return
	 * @author ZuKang.Song
	 * @since 2016年6月8日下午12:10:51
	 */
	public String updateServerInfo(String id, String ip, String port, String status, String description) {
		return this.getOrderDao().updateServerInfo(id, ip, port, status, description);
	}
	 ...
	 * @return
	 * @author ZuKang.Song
	 * @since 2016年6月8日下午3:07:13
	 */
	public String delServerInfo(String id) {
		return this.getOrderDao().delServerInfo(id);
	}
	 ...
	 * @return
	 * @author ZuKang.Song
	 * @since 2016年6月13日下午5:15:35
	 */
	public ArrayList<Order> getOrderList(String userId, String startTime, String endTime, String status, int page, int pageSize) {
		return this.getOrderDao().getOrderList(userId, startTime, endTime, status, page, pageSize);
	}
	 ...
	 * @since 2016年6月13日下午5:15:35
	 */
	public ArrayList<Order> getOrderList(String startTime, String endTime, String status, int page, int pageSize) {
		return this.getOrderDao().getOrderList(startTime, endTime, status, page, pageSize);
	}
	 ...
	 * @return
	 * @author ZuKang.Song
	 * @since 2016年6月23日下午3:27:19
	 */
	public String createBatchInfo(String batchFee, String batchNum) {
		String batchNo = KeyGenerator.createUniqueId();
		if (Constant.OperaterStatus.SUCESSED.getValue().equals(this.getOrderDao().createBatchInfo(batchNo, batchNum, batchFee))) {
			return batchNo;
		}
	 ...
	 * @return
	 * @author ZuKang.Song
	 * @since  2016年6月24日下午5:14:09
	 */
	public boolean getBatchInfo(String batchNo) {
		return this.getOrderDao().getBatchInfo(batchNo);
	}
