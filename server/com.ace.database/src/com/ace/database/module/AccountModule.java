...
public class AccountModule extends BasicModule {
	...
	public BigDecimal getIncome(String userId) {
		return this.getAccountDao().getIncome(userId);
	}
	 ...
	 */
	public HashMap<String, ArrayList<AccountDetail>> getAccountDetailList(String userId, Constant.ChangeType type, String beginTime, String endTime, int page, int pageSize, String logicType) {
		return this.getAccountDao().getAccountDetailList(userId, beginTime, endTime, type, page, pageSize, logicType);
	}
