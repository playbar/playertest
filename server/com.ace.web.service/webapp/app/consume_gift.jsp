...
<%
   ...
   //String requestJson = "{\"exeStatus\":\"1\",\"giftDetailList\":[{\"cnt\":15,\"createTime\":\"2016-06-28 15:10:17\",\"day\":\"2016-06-28\",\"giftId\":\"23\",\"receiverId\":\"2409\",\"senderId\":\"2409\",\"showId\":\"2409\",\"updateTime\":\"2016-06-28 15:10:17\"},{\"cnt\":1,\" createTime\":\"2016-06-28 14:24:06\",\"day\":\"2016-06-28\",\"giftId\":\"22\",\"receiverId\":\"4410\",\"senderId\":\"2409\",\"showId\":\"4410\",\"updateTime\":\"2016-06-28 14:24:06\"},{\"cnt\":76,\"createTime\":\"2016-06-24 20:48:28\",\"day\":\"2016-06-22\",\"giftId\":\"11\",\"receiverId\":\"4750\",\"senderId\":\"2409\",\"showId\":\"4750\",\"updateTime\":\"2016-06-24 20:48:28\"},{\"cnt\":1,\" createTime\":\"2016-06-24 20:48:28\",\"day\":\"2016-06-22\",\"giftId\":\"22\",\"receiverId\":\"2409\",\"senderId\":\"2409\",\"showId\":\"4750\",\"updateTime\":\"2016-06-24 20:48:28\"},{\"cnt\":1,\" createTime\":\"2016-06-24 20:48:28\",\"day\":\"2016-06-22\",\"giftId\":\"23\",\"receiverId\":\"4750\",\"senderId\":\"2409\",\"showId\":\"4750\",\"updateTime\":\"2016-06-24 20:48:28\"},{\"cnt\":1,\" createTime\":\"2016-06-24 20:48:28\",\"day\":\"2016-06-22\",\"giftId\":\"25\",\"receiverId\":\"3117\",\"senderId\":\"2409\",\"showId\":\"4750\",\"updateTime\":\"2016-06-24 20:48:28\"},{\"cnt\":1,\" createTime\":\"2016-06-24 20:39:05\",\"day\":\"2016-06-22\",\"giftId\":\"25\",\"receiverId\":\"2449\",\"senderId\":\"2409\",\"showId\":\"2449\",\"updateTime\":\"2016-06-24 20:39:05\"},{\"cnt\":14,\"createTime\":\"2016-06-24 20:35:54\",\"day\":\"2016-06-22\",\"giftId\":\"22\",\"receiverId\":\"2449\",\"senderId\":\"2409\",\"showId\":\"2449\",\"updateTime\":\"2016-06-24 20:35:54\"}]}"; 
	   ...
	   if("1".equals(jsonObj.get("exeStatus"))){
		   ...
		   for(int i=0;i<olj.size();i++){
			   ...
			   if(mapString.get(ymd) == null){
                 ...
                 outHtml.append(ymd);
                 outHtml.append("</p><p>总计:"+price+"(金币)</p>");
                 outHtml.append("</div>");
			   }
			   ...
			   if(mapString.get(day) == null){
				    ...
				    outHtml.append("<p>送给 : "+map.get("nickName")+"</p>");
				   	outHtml.append("<p>"+map.get("sendPrice")+"</p>");
				   	String description = map.get("description");
				   	description = description.substring(0,description.length()-1);
				    outHtml.append("<p>详情：送出"+description+"</p>");
			   ...
			   if(map.get("mark") != null){
				   ...
				   for(int a=0; a<markList.length; a++){
					   String n = markList[a];
						outHtml.append("<div class=\"list\">");
					   	outHtml.append("<div class=\"list-single\">");
					    outHtml.append("<p>送给 : "+map.get(n+"nickName")+"</p>");
...
<%!
	...
	public Map<String,String> getDesc(JSONArray ja,int i){
		...
		String day = oj.getString("day");
		String receiverId = oj.getString("receiverId");
		...
		if(!dayArray.contains(day)){
			...
			if(!receiverArray.contains(receiverId)){
				...
				for(int n=i; n<ja.size(); n++){
					...
					String receiver = obj.getString("receiverId");
					Gift gift =  StaticDataManager.getGift("5");
					BigDecimal price = gift.getSendPrice();
