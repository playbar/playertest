...
<html>
	...
	<%
        ...
        //收银台页面上，商品展示的超链接，必填
        //String show_url = new String(request.getAttribute("WIDshow_url").getBytes("ISO-8859-1"),"UTF-8");
		
        //商品描述，可空
        String body = ""+request.getParameter("WIDbody");
        //index是官网充值，charge是页面充值，显示不同返回页面
		...
		sParaTemp.put("return_url", PPConfiguration.getProperties("cfg.properties").getString("alipay."+channel+".sucess.url"));
