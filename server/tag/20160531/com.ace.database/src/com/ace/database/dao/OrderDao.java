...
public class OrderDao extends BasicDao {
	...
	public String createOrder(Order order) {
		...
		try {
			String sql = " insert into order_detail (orderId,thirdId,payerId,payerName,receiverId,receiverName,goodId,goodCnt,goodName,status,payChannel,orderDes,rmbAmount,coinAmount,updateTime,createTime) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
			ps = this.getConnnection().prepareStatement(sql);
	...
	public ArrayList<Order> getOrderList(String userId, String beginTime, String endTime, String status, int page, int pageSize) {
		...
		try {
			String sql = " select orderId,payerId,payerName,receiverId,receiverName,goodId,goodCnt,goodName,status,payChannel,orderDes,rmbAmount,payedAmount,coinAmount,rate,operatorId,operatorName,openTime,updateTime,createTime from order_detail where receiverId=? and status=? and createTime>=? and createTime<=? order by createTime desc limit ?,?";
			ps = this.getConnnection().prepareStatement(sql);
	...
	public Order getOrder(String orderId) {
		...
		ResultSet rs = null;
		try {
			String sql = " select orderId,payerId,payerName,receiverId,receiverName,goodId,goodCnt,goodName,status,payChannel,orderDes,rmbAmount,payedAmount,coinAmount,rate,operatorId,operatorName,openTime,updateTime,createTime from order_detail where orderId=?";
			ps = this.getConnnection().prepareStatement(sql);
	...
	public Order getOrderWithThirdId(String thirdId) {
		...
		ResultSet rs = null;
		try {
			String sql = " select orderId,thirdId,payerId,payerName,receiverId,receiverName,goodId,goodCnt,goodName,status,payChannel,orderDes,rmbAmount,payedAmount,coinAmount,rate,operatorId,operatorName,openTime,updateTime,createTime from order_detail where thirdId=?";
			ps = this.getConnnection().prepareStatement(sql);
