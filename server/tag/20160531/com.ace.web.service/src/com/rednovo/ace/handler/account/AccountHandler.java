...
public class AccountHandler extends BasicServiceAdapter {
	...
	private void getAccountDetailList() {
		...
		HashMap<String, ArrayList<AccountDetail>> map = AccountService.getAccountDetail(userId, Constant.ChangeType.ADD.getValue().equals(channel) ? Constant.ChangeType.ADD : Constant.ChangeType.REDUCE, beginTime, endTime, page, pageSize);
