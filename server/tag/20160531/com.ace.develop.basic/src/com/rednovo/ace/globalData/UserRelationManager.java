...
public class UserRelationManager {
	...
	public static void addFans(String userId, String... fansIds) {
		RedisService.getServer(CacheName.USER_FANS_DATA.getNode()).addList(USER_FANS_LIST + "_" + userId, fansIds);
	}
	...
	public static void addSubscribe(String userId, String... starIds) {
		RedisService.getServer(CacheName.USER_SUBCRIBE_DATA.getNode()).addList(USER_SUBSCRIBE_LIST + "_" + userId, starIds);
	}
