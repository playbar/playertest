...
public class StaticDataManager {
	...
	private static String SYS_KEY_WORD_LIST = "sys_key_word_list";// 系统关键词
	...
	public static void addKeyWord(String... key) {
		RedisService.getServer(CacheName.STATIC_DATA.getNode()).addList(SYS_KEY_WORD_LIST, key);
	}

	public static List<String> getKeyWord() {
		return RedisService.getServer(CacheName.STATIC_DATA.getNode()).getList(SYS_KEY_WORD_LIST);
	}
}
