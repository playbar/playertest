...
public class JPushService {
	...
	private static final String appKey = PPConfiguration.getProperties("cfg.properties").getString("app.pushed.key");
	private static final String masterSecret = PPConfiguration.getProperties("cfg.properties").getString("app.pushed.mastercecret");
