...
static void
IjkMediaPlayer_native_setSize(JNIEnv *env, jclass clazz, jint play_width, jint play_height)
{
    
    __android_log_print(ANDROID_LOG_INFO,"jnilog","native_setSize width=%d, height=%d", play_width, play_height);
    MPTRACE("%s(%d,%d)\n", __func__, play_width, play_height);

    my_set_out_size(play_width, play_height);    
...
static JNINativeMethod g_methods[] = {
    ...
    { "native_setSize",         "(II)V",                    (void *) IjkMediaPlayer_native_setSize },
};
