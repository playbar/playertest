...
LIBRTMP=$FF_BUILD_ROOT/../../librtmp
echo "LIBRTMP: $LIBRTMP"

X264=$FF_BUILD_ROOT/../../x264
echo "x264: $X264"

FDK_AAC=$FF_BUILD_ROOT/../../fdk-aac
...
FFMPEG_CFLAGS="$FFMPEG_CFLAGS -I$LIBRTMP/include"
FFMPEG_CFLAGS="$FFMPEG_CFLAGS -I$X264/include"
FFMPEG_CFLAGS="$FFMPEG_CFLAGS -I$FDK_AAC/include"

FFMPEG_LDFLAGS="$FFMPEG_CFLAGS"
FFMPEG_LDFLAGS="$FFMPEG_LDFLAGS -L$LIBRTMP/lib"
FFMPEG_LDFLAGS="$FFMPEG_LDFLAGS -L$X264/lib"
FFMPEG_LDFLAGS="$FFMPEG_LDFLAGS -L$FDK_AAC/lib"
...
echo "[*] set pkg config"
echo "----------------------"
export PKG_CONFIG_PATH=$FF_BUILD_ROOT/../../librtmp/lib/pkgconfig:$PKG_CONFIG_PATH
