...
LIBRTMP_INC="$FF_BUILD_ROOT/../../../rtmpdump-2.4/build/android/include"
LIBRTMP_LIB="$FF_BUILD_ROOT/../../../rtmpdump-2.4/build/android/lib"
FDKAAC_INC="$FF_BUILD_ROOT/../../../fdk-aac-0.1.4/build/android/include"
FDKAAC_LIB="$FF_BUILD_ROOT/../../../fdk-aac-0.1.4/build/android/lib"
X264_INC="$FF_BUILD_ROOT/../../../x264/build/android/include"
x264_LIB="$FF_BUILD_ROOT/../../../x264/build/android/lib"

FF_EXTRA_CFLAGS="$FF_EXTRA_CFLAGS -I$LIBRTMP_INC"
FF_EXTRA_CFLAGS="$FF_EXTRA_CFLAGS -I$FDKAAC_INC"
FF_EXTRA_CFLAGS="$FF_EXTRA_CFLAGS -I$X264_INC"

FF_EXTRA_LDFLAGS="$FF_EXTRA_LDFLAGS -L$LIBRTMP_LIB"
FF_EXTRA_LDFLAGS="$FF_EXTRA_LDFLAGS -L$FDKAAC_LIB"
FF_EXTRA_LDFLAGS="$FF_EXTRA_LDFLAGS -L$x264_LIB"


FF_DEP_LIBS="-L$FF_DEP_LIBS -lx264"
FF_DEP_LIBS="-L$FF_DEP_LIBS -lfdk-aac"
FF_DEP_LIBS="-L$FF_DEP_LIBS -lrtmp"

ln -s /usr/bin/pkg-config $FF_BUILD_ROOT/build/ffmpeg-armv7a/toolchain/bin/arm-linux-androideabi-pkg-config

export PKG_CONFIG_PATH=$LIBRTMP_LIB/pkgconfig:$PKG_CONFIG_PATH
