...
public final class IjkMediaPlayer extends AbstractMediaPlayer {
    ...
    protected void finalize() throws Throwable {
        ...
        try {
            ...
            // java.util.concurrent.TimeoutException: tv.danmaku.ijk.media.player.IjkMediaPlayer.finalize() timed out after 10 seconds
            //超时崩溃
            ex.printStackTrace();
        }
    ...
    public native void native_setSize(int width, int height);
}
