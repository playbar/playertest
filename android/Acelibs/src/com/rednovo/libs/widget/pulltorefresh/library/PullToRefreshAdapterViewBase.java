...
import com.rednovo.libs.widget.pulltorefresh.library.internal.EmptyViewMethodAccessor;
import com.rednovo.libs.widget.pulltorefresh.library.internal.IndicatorLayout;
...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements
	...
	public final void onScroll(final AbsListView view, final int firstVisibleItem, final int visibleItemCount,
		...
		if (null != mOnScrollListener /*&& !isRefreshing()*/) {
		...
		if (null == adapter || adapter.isEmpty()) {
			...
			if (mRefreshableView.getFirstVisiblePosition() <= 1) {
				...
				if (firstVisibleChild != null) {
					...
					if(firstVisibleChildTop ==-1){
						firstVisibleChildTop = 0;
					}
					return firstVisibleChildTop >= mRefreshableView.getTop();
				}
			}
		}
