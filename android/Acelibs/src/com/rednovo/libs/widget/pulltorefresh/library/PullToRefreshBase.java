...
import com.rednovo.libs.widget.pulltorefresh.library.internal.FlipLoadingLayout;
import com.rednovo.libs.widget.pulltorefresh.library.internal.LoadingLayout;
import com.rednovo.libs.widget.pulltorefresh.library.internal.MyLoadingLayout;
import com.rednovo.libs.widget.pulltorefresh.library.internal.PulltoRefreshUtils;
import com.rednovo.libs.widget.pulltorefresh.library.internal.RotateLoadingLayout;
import com.rednovo.libs.widget.pulltorefresh.library.internal.ViewCompat;
...
//				}
	...
	protected final void setHeaderScroll(int value,boolean boo) {
		setHeaderScroll_inner(value);
		onHeaderScrol(boo,value);
	}
	
	private final void setHeaderScroll_inner(int value){
	...
	private void pullEvent() {
		...
		if (newScrollValue != 0 && !isRefreshing()) {
			setHeaderScroll(newScrollValue);    // 正在加载时不允许滑动列表
