...
public class MTextView extends TextView {
     ...
     * {@link BackgroundColorSpan}用
     */
    private Paint textFgColorPaint = new Paint();
    /**
     * {@link BackgroundColorSpan}用
     */
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        paint.setShadowLayer(1, 2, 2, 0xff000000);
            ...
            for (int j = 0; j < aContentList.line.size(); j++) {
                ...
                if (ob instanceof String) {
                    ...
                    if (span instanceof DynamicDrawableSpan) {
                        ...
                        textFgColorPaint.setColor(((ForegroundColorSpan) span).getForegroundColor());
                        textFgColorPaint.setAntiAlias(true);
                        textFgColorPaint.setTextSize(this.getTextSize());
                        textFgColorPaint.setShadowLayer(1, 2, 2, 0xff000000);
                        canvas.drawText(((SpanObject) ob).source.toString(), realDrawedWidth, height + aContentList.height - mFontMetrics.descent, textFgColorPaint);
                        realDrawedWidth += width;
                    }
                    else//做字符串处理
                    {
