...
public class PanelLayout extends LinearLayout {
    ...
    public void refreshHeight() {
        ...
        if (getHeight() == KeyBoardUtils.getValidPanelHeight(getContext())) {
            return;
        }
        ...
        post(new Runnable() {
            ...
            public void run() {
                ...
                if (layoutParams == null) {
                    layoutParams = new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, KeyBoardUtils.getValidPanelHeight(getContext()));
                } else {
                    layoutParams.height = KeyBoardUtils.getValidPanelHeight(getContext());
                }
