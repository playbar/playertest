...
public class GPUImageFilter {
    ...
    public int onDrawFrameBeauty(VideoManager mVideoManager,final int textureId, final FloatBuffer cubeBuffer,final FloatBuffer textureBuffer){
    	return 0;
    }
    
    public int onDrawFrameBeauty(VideoManager VideoManager,final int textureId){
    	return 0;
    }
